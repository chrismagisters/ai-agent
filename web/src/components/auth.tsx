...
export function AuthDialog({
  ...
  useEffect(() => {
    form.setValue("openaiAPIKey", pgState.openaiAPIKey || " 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");
